...
% JACOBI METHOD FOR ITERATIVE SOLUTION OF A LINEAR SYSTEM
...
% provided, via the Jacobi Method. It also provides the number of
...
while (1) % stopping condition is checked at the end
    for i = 1:n
        x_k(i,1) = (b(i,1) - (A(i,1:i-1)*x_0(1:i-1,1) + ...
    ...
    x_0 = x_k; % otherwise, continue and increase counter
    k = k+1;
end
